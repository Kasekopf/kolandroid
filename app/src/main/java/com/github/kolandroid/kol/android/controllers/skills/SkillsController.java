...
public class SkillsController extends GroupController<SkillsSubmodel, SkillsModel> implements UpdateController<SkillsModel> {
    /**
    ...
    @Override
    public Class<SkillsModel> getUpdateType() {
        return SkillsModel.class;
    }
}
