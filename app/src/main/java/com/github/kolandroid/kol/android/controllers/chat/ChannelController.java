...
import com.github.kolandroid.kol.model.models.chat.stubs.ChannelStubModel;

import java.util.ArrayList;
import java.util.List;

public class ChannelController extends ChatStubController<ChannelStubModel> {
    /**
    ...
    public ChannelController(ChatModel model, String tag) {
        super(new ChannelStubModel(model, tag));
        this.name = tag;
    }

    @Override
    public void doConnect(View view, ChannelStubModel model, final Screen host) {
    ...
    @Override
    public void receiveProgress(View view, ChannelStubModel model, Iterable<ChatModelSegment> message, Screen host) {
        if (adapter == null)
            return;
