...
public class InventoryModel extends ParentModel<Void> {
	...
	public class InvItem extends BasicSubtextItem {
		/**
		 * Autogenerated by eclipse.
		 */
		...
		public InvItem(String name, String url, ArrayList<ActionItem> actions) {
			super(name, url);
			this.actions = actions;
		}

		public InvItem(String name, String url, String subtext,
