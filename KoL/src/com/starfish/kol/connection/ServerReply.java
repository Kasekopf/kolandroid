...
public class ServerReply implements Serializable {
	...
	protected ServerReply(PartialServerReply reply, String html) throws IOException {
	...
	protected ServerReply(PartialServerReply reply, HttpURLConnection base) throws IOException {
		this(reply, getResponse(base));
	}

	private static String getResponse(HttpURLConnection base) throws IOException {
