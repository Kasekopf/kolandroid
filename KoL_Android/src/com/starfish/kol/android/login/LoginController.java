...
public class LoginController extends ModelController<LoginStatus, LoginModel> {
	/**
	...
	public void recieveProgress(View view, LoginModel model, LoginStatus message, Screen host) {
		switch (message) {
		case SUCCESS:
